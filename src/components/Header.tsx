        ...
        {user ? (
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              {isOpen && (
                <div className="absolute right-0 mt-2.5 w-80 max-h-96 overflow-y-auto bg-slate-950 border border-slate-900 rounded-2xl p-4 shadow-2xl space-y-4 z-50 text-left">
